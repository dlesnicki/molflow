...
!                  %----------------%
  ...
  namelist /data/ directory,filename,nskips,nprint,Nmonomer, referential
  namelist /rdf/ dr, limit
...
!                  %----------------%
        ...
        write(88,*)
        do iatm=1,natoms
           write(88,*)symbol(iatm),configuration(:,iatm)
        end do
